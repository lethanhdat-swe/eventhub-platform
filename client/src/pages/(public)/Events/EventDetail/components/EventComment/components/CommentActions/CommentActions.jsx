  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full text-(--text-primary)/50 transition-all duration-300 hover:bg-white/5 hover:text-fuchsia-400 hover:shadow-[0_0_20px_rgba(236,72,153,0.25)]">
