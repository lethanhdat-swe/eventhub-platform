  ...
  return (
    <MotionSection className="container mt-16">
      ...
      >
        ...
        >
          <MotionButton>
            <button className="group flex items-center gap-2 rounded-full border border-(--text-primary)/10 bg-(--surface-color) px-5 py-2.5 text-sm font-bold whitespace-nowrap text-(--text-primary)/80 shadow-sm transition-colors duration-300 hover:border-(--primary-color)/40 hover:text-(--primary-color) md:px-6 md:py-3">
              Xem tất cả
              <ArrowRight
                size={17}
