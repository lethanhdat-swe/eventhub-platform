...
function OrderCard({ order }) {
    const getStatusStyle = (status) => {
        switch (status) {
            case 'Đã đặt':
                return {
                    badge: 'border-emerald-400/30 bg-emerald-500/20 text-emerald-300 shadow-[0_0_24px_rgba(16,185,129,0.28)]',
                    dot: 'bg-emerald-400 shadow-[0_0_12px_rgba(52,211,153,0.9)]',
                };

            case 'Đang xử lý':
                return {
                    badge: 'border-yellow-400/35 bg-yellow-500/20 text-yellow-300 shadow-[0_0_24px_rgba(234,179,8,0.25)]',
                    dot: 'bg-yellow-300 shadow-[0_0_12px_rgba(253,224,71,0.9)]',
                };

            case 'Đã hủy':
                return {
                    badge: 'border-red-400/35 bg-red-500/25 text-red-300 shadow-[0_0_24px_rgba(239,68,68,0.32)]',
                    dot: 'bg-red-400 shadow-[0_0_12px_rgba(248,113,113,0.9)]',
                };

            case 'Đang chờ hoàn tiền':
                return {
                    badge: 'border-amber-400/35 bg-amber-500/20 text-amber-300 shadow-[0_0_24px_rgba(245,158,11,0.25)]',
                    dot: 'bg-amber-400 shadow-[0_0_12px_rgba(251,191,36,0.9)]',
                };

            case 'Đã hoàn tiền':
                return {
                    badge: 'border-orange-400/35 bg-orange-500/20 text-orange-300 shadow-[0_0_24px_rgba(249,115,22,0.28)]',
                    dot: 'bg-orange-400 shadow-[0_0_12px_rgba(251,146,60,0.9)]',
                };

            default:
                return {
                    badge: 'border-white/15 bg-white/10 text-white shadow-[0_0_20px_rgba(255,255,255,0.12)]',
                    dot: 'bg-white/70',
                };
        }
    };
        ...
        >
            ...
            <div className="relative">
                <img
                    src={order.image}
                    alt={order.title}
                    className="object-cover w-full transition-transform duration-700 h-44 sm:h-52 "
                />
