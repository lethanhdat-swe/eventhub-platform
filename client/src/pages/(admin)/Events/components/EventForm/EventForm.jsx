                    ...
                    <FormField label="Danh sách nghệ sĩ" htmlFor="">
                        <div className="space-y-3">
                            {form.artists.length === 0 ? (
                                <div className="px-3 py-3 text-sm border border-dashed rounded-md border-slate-200 bg-slate-50 text-slate-500">
                ...
                <CardContent className="pt-3 space-y-3">
                    ...
                    <FormField label="Trạng thái" htmlFor="status">
                        ...
                        >
                            <SelectTrigger
                                id="status"
                                className="w-full h-9 md:max-w-xs"
                            >
