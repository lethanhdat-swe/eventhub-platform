          ...
          <div className="grid gap-3 py-2">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="space-y-1.5">
                <Label htmlFor="add-seat-row">Hàng ghế</Label>
                <Input
                  id="add-seat-row"
                  value={form.rowLabel}
                  onChange={(event) =>
              ...
              <div className="space-y-1.5">
                <Label htmlFor="add-seat-number">Số ghế</Label>
                <Input
                  id="add-seat-number"
                  type="number"
                  min={1}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="add-seat-ticket-type">Loại vé mặc định</Label>
              <TicketTypeSelect
                id="add-seat-ticket-type"
