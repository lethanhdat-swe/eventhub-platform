...
export const GooglePlayIcon = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
    <path
      fill="#00C853"
      d="M3.18 23.76c.3.17.64.22.99.14l12.6-7.28-2.7-2.7-10.89 9.84z"
    />
    <path
      fill="#00B0FF"
    ...
    <path
      fill="#FF3D00"
      d="M3.18.24L15.78 7.52l-2.7 2.7L2.19.38c.35-.09.69-.04.99.14z"
    />
  </svg>
);
...
export const MastercardIcon = ({ size = 24, ...props }) => (
  ...
  >
    ...
    <path
      fill="#FF5F00"
      d="M390 132.7a150 150 0 0 1 0 234.6 150 150 0 0 1 0-234.6z"
    />
  </svg>
);
